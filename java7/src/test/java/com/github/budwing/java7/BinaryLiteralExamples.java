...
public class BinaryLiteralExamples {
    ...
    /**
     * No. 1
     * TODO: Do you remember other number literal expression, like binary, oct, hex, list them here, add them in this method.
     */
    @Test
    public void tryBinaryOctHex() {
        Assert.fail("replace me with binary, oct, hex");
    }

    /**
     * No. 2
     * by default, binary number's type is int
     * TODO: try to remove type cast to see what will happen, and explain why
     */
    @Test
    public void whyCast() {
        // remove (byte), it's OK
        ...
        Assert.fail("figure out why short needs cast");
    }
}
