...
public class TryWithResourceExamples {
     ...
     *
     * TODO: The connection needs to be shared between two try-catch block, how to do that?
     */
    @Test
    public void tryShareRes() {
        ...
        try (Connection connection = DriverManager.getConnection("a url");
            ...
            log.info("you should see this message: {}", exception.getMessage());
            Assert.assertTrue(exception instanceof SQLException);
        }
        Assert.fail("share connection between try-catch");
    }
}
