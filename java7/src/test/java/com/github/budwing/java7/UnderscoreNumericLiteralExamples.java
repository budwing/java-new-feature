...
public class UnderscoreNumericLiteralExamples {
     ...
     *
     * TODO: try to switch language level to see _ variable changes
     */
    @Test
    public void tryUnderscoreVariable() {
        int _ = 100;
        log.info("underscore is a legal variable name: {}", _);
        Assert.fail("try to switch language level to see _ variable changes");
    }
}
