package com.github.budwing.java7.nio;
...
public class FilesExamples {
    ...
    /**
     * TODO: list all directories in your home folder by FileVisitor
     */
    @Test
    public void tryListAllDirectoriesInHome() {
        String home = System.getProperty("user.home");
        log.info("your home folder is {}", home);
        Assert.fail("list all directories in your home folder by FileVisitor");
    }
}
